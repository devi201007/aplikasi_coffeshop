  ...
  if ($email === '' || $password === '') {
    ...
    if ($stmt) {
      ...
      if ($user && $passwordMatches) {
        ...
        $_SESSION['user_nama'] = (string) $user['nama'];
      ...
      $errorMessage = 'Terjadi masalah pada server. Coba lagi.';
    }
  }
}
?>
...
<html lang="en">
  ...
  <head>
    ...
    <title>Kedai Kopi | Login Admin</title>
  ...
  <body class="login-page bg-body-secondary">
    <div class="login-box">
      <div class="login-logo">
        <a href="login.php"><i class="bi bi-cup-hot-fill me-2"></i><b>Kedai</b> Kopi</a>
      </div>
      <!-- /.login-logo -->
      <div class="card">
        <div class="card-body login-card-body">
          <p class="login-box-msg">Masuk untuk mengelola Kedai Kopi Anda</p>
          ...
          <p class="text-center text-secondary small mb-0 mt-3">
            <i class="bi bi-shield-lock me-1"></i>Halaman ini khusus untuk admin Kedai Kopi.
          </p>
        </div>
        <!-- /.login-card-body -->
      </div>
